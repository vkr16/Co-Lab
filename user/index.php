                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 px-2">
                            <div class="card shadow mb-3">
                                <img src="../assets/img/rooms/lab-komputer.jpg" class="card-img-top thumbnail-card-img" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title text-dark">Laboratorium Kimia</h5>
                                    <h6 class="card-subtitle mb-2 text-muted">Kapasitas 30 Orang</h6>
                        ...
                        <div class="col-md-3 px-2">
                            <div class="card shadow mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <h6 class="card-subtitle mb-2 text-muted">Kapasitas 30 Orang</h6>
                                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    <a href="#" class="btn btn-danger">Booked</a> until Today 5:15 PM
                                </div>
                            </div>
                        </div>
                        <!-- row item end -->
